<?php
$work_scheme = [
  1 => 'Заполните <button type="button" data-order-button="Заполните форму заявки">форму заявки</button> или позвоните нам<br> по бесплатному номеру<br> <a href="tel:88007077353"><strong>8 (800) 707-73-53</strong></a>',
